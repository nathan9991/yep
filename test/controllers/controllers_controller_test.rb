...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { body: @controller.body, post: @controller.post, posted_at: @controller.posted_at, published: @controller.published, title: @controller.title } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { body: @controller.body, post: @controller.post, posted_at: @controller.posted_at, published: @controller.published, title: @controller.title } }
